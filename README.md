...
# What does it do?
LoadLib uses the LoadLibraryW function on Windows to load a selected DLL at runtime. Though noisy in most anticheat environments, it makes for a useful tool when testing internal hacks on programs with no anticheat.
